...
if __name__ == "__main__":
    ...
    # args.message = """
    # Predict the answer of the last question based on following Q&A examples. You have to strictly follow the answer format.
    
    # Q1. What is the color of apple?
    # A1. Red.
    
    # Q2. What is the color of pineapple?
    # A2. Yellow.
    
    # Q3. What is the color of watermelon?
    # A3. 
    # """
